...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  newUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<MutationNewUserArgs, never>>;
  assignRole?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<MutationAssignRoleArgs, never>>;
  newDepartment?: Resolver<ResolversTypes['Department'], ParentType, ContextType, RequireFields<MutationNewDepartmentArgs, never>>;
